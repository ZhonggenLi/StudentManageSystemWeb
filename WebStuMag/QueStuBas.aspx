<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueStuBas.aspx.cs" Inherits="WebStuMag.QueStuBas" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Table ID="Table1" runat="server" Width="1509px">
            <asp:TableRow runat="server">
                ...
                <asp:TableCell runat="server" Width="80px">性别：</asp:TableCell>
